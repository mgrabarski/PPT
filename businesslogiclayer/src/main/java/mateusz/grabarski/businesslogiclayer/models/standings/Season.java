...
public class Season {
    ...
    public Season(String endDate, String name, String seasonId, String lastUpdated, Round round, String lastPlayedMatchDate, String startDate, String serviceLevel) {
        this.endDate = endDate;
        this.name = name;
        this.seasonId = seasonId;
        this.lastUpdated = lastUpdated;
        this.round = round;
        this.lastPlayedMatchDate = lastPlayedMatchDate;
    ...
    public String getLastPlayedMatchDate() {
        return lastPlayedMatchDate;
    }

    public void setLastPlayedMatchDate(String lastPlayedMatchDate) {
        this.lastPlayedMatchDate = lastPlayedMatchDate;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (getRound() != null ? !getRound().equals(season.getRound()) : season.getRound() != null)
            return false;
        if (getLastPlayedMatchDate() != null ? !getLastPlayedMatchDate().equals(season.getLastPlayedMatchDate()) : season.getLastPlayedMatchDate() != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (getLastPlayedMatchDate() != null ? getLastPlayedMatchDate().hashCode() : 0);
    ...
    public String toString() {
        return "Season{" +
                ...
                ", round=" + round +
                ", lastPlayedMatchDate='" + lastPlayedMatchDate + '\'' +
                ", startDate='" + startDate + '\'' +
